  ...
  return (
    <footer className="w-full py-8 border-t border-terminal-green/10">
      <div className="max-w-6xl mx-auto px-6">
        {/* Contact Items Grid */}
        <div className="mb-12">
          <h3 className="text-xl font-bold mb-6 text-terminal-green">Contact</h3>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {contacts.map((item) => (
              <div 
                key={item.label}
                className="bg-[#0d1117] border border-[#1b2430] p-5 hover:border-[#00cc7d] transition-colors duration-300"
              >
                <div className="text-[10px] tracking-[2px] uppercase text-[#6e7a88] mb-1.5">{item.label}</div>
        ...
        {/* New footer section */}
        <div className="mt-16 pt-6 border-t border-[#1b2430] flex justify-between flex-wrap gap-3 text-[11px] text-[#6e7a88] pb-8">
          <span>sec-ops-terminal v3.0 · Jayesh Choudhary · CISSP · CISM · CISA</span>
          <span>MODULES: 6 ACTIVE · SECURE</span>
        </div>

        <div className="mt-8 pt-6 border-t border-terminal-green/5 text-center">
